<div id="sample">
    ...
    <textarea cols="50" id="area4">HTML content default in textarea</textarea>
    <h4>
    ...
    <textarea style="height: 100px;" cols="50" id="area5">HTML content default in textarea</textarea>
  </div>